...
U_NP,              U_NP,              U_LT(U_MEDIA, ESC),U_LT(U_NAV, BSPC), U_LT(U_MOUSE, SPACE),U_LT(U_SYM, TAB),U_LT(U_NUM, RET),  U_LT(U_FUN, DEL),  U_NP,              U_NP
...
U_NP,              U_NP,              &kp K_APP,         &kp BSPC,          &kp SPACE,           U_NA,              U_NA,              U_NA,              U_NP,              U_NP
