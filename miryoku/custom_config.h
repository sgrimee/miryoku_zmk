...
\
&kp LCTRL,         &kp LALT,          &kp LGUI,          &kp LSHFT,         U_CPY,             \
U_CPY,             &kp RSHFT,         &kp RGUI,          &kp LALT,          &kp RCTRL,         \
\
U_UND,             U_CUT,             U_CPY,             U_PST,             U_PST,             \
U_PST,             U_PST,             U_CPY,             U_CUT,             U_UND,             \
\
U_NP,              U_NP,              U_BTN3,            U_BTN1,            U_BTN2,            \
...
\
&kp LCTRL,         &kp LALT,          &kp LGUI,          &kp LSHFT,         U_NA,              \
U_EP_TOG,          &kp C_PREV,        &kp C_VOL_DN,      &kp C_VOL_UP,      &kp C_NEXT,        \
\
U_NA,              &kp RALT,          &u_to_U_FUN,       &u_to_U_MEDIA,     U_NA,              \
&u_out_tog,        &u_bt_sel_0,       &u_bt_sel_1,       &u_bt_sel_2,       &u_bt_sel_3,       \
\
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              \
...
\
U_NA,              &u_to_U_NUM,       &u_to_U_NAV,       &kp RALT,          U_NA,              \
...
U_NA,              &u_to_U_SYM,       &u_to_U_MOUSE,     &kp RALT,          U_NA,              \
\
U_NP,              U_NP,              &kp LPAR,          &kp RPAR,          &kp UNDER,         \
